...
def _build_minimal_openapi() -> dict:
    return {
        ...
        "paths": {
            ...
            "/api/v1/user/": {"get": {"summary": "Current user", "security": [{"BearerAuth": []}], "responses": {"200": {"description": "User details", "content": {"application/json": {"schema": {"$ref": "#/components/schemas/User"}}}}, "401": {"description": "Unauthorized", "content": {"application/json": {"schema": {"$ref": "#/components/schemas/ErrorResponse"}}}}}}},
            "/api/v1/user/usage": {"get": {"summary": "Usage status", "security": [{"BearerAuth": []}], "responses": {"200": {"description": "Usage details", "content": {"application/json": {"schema": {"$ref": "#/components/schemas/UsageStatus"}}}}}}},
        ...
        "components": {
            ...
            "schemas": {
                ...
                "User": {"type": "object", "required": ["id", "email", "role"], "properties": {"id": {"type": "string"}, "email": {"type": "string", "format": "email"}, "role": {"type": "string"}, "plan_code": {"type": ["string", "null"]}, "subscription_status": {"type": ["string", "null"]}}},
